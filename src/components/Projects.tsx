      ...
      <div className="mx-auto max-w-6xl px-6 py-24 md:px-8 md:py-28">
        <div className="mb-14 flex flex-col gap-6 md:flex-row md:items-end md:justify-between">
          ...
          <p className="max-w-sm text-ink-soft">
            Apps and web platforms across various industries.
          </p>
        </div>
        ...
        <ul className="divide-y divide-line border-y border-line">
          {projects.map((project, index) => (
            ...
            >
              ...
              <div>
                <h3 className="font-[family-name:var(--font-display)] text-xl font-bold tracking-tight text-ink transition group-hover:text-accent md:text-2xl">
                  {project.name}
                </h3>
