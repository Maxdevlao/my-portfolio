...
export const stacks = [
  ...
  {
    label: "Frontend",
    items: ["Next.js", "React", "Vue.js"],
  },
  {
    label: "Backend",
    items: ["Express", "NestJS", "Node.js / TypeScript"],
  },
  {
    label: "Database",
...
export const experience = [
  {
    ...
    place: "Auton Lao Company",
    detail: "Building and shipping full stack products across mobile and web.",
    href: "https://auton.kr/",
  },
  {
    period: "2022 — 2024",
